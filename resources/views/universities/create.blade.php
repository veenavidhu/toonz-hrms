    ...
    <div class="max-w-[1600px] mx-auto px-6 pb-12">
        <div class="glass-card overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-100 bg-white/50 flex items-center gap-3">
                ...
                <h2 class="text-lg font-black text-gray-800 tracking-tight uppercase">ADD NEW UNIVERSITY</h2>
            </div>

            <form action="{{ route('universities.store') }}" method="POST" class="p-8 space-y-8">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                    <div>
                        ...
                        <input type="text" name="university_name" value="{{ old('university_name') }}" placeholder="Enter University Name"
