        ...
        <div class="glass-card overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-gray-100 bg-white/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-gray-800 tracking-tight text-uppercase">ADD NEW SUB FUNCTION</h2>
                    </div>
                </div>
            </div>

            <form action="{{ route('sub-functions.store') }}" method="POST" class="p-8 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="sub_function_code" value="{{ old('sub_function_code') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="sub_function_name" value="{{ old('sub_function_name') }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="head_id" 
                                ...
                                <option value="" disabled selected>Select Sub Function Head</option>
