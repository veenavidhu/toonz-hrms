<x-app-layout> <x-slot name="header"> Business Unit Master </x-slot>
        ...
        @if (session('success'))
            ...
            @endif <div class="glass-card overflow-hidden"> <!-- Header & Actions -->
                <div
                    ...
                    <h2 class="text-xl font-black text-gray-800 tracking-tighter">Business Units</h2>
                    <div class="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto" x-data="{ showImportModal: false }">
                        ...
                        <!-- Add Button --> <a href="{{ route('business-units.create') }}"
                        ...
                        <div x-show="showImportModal" style="display: none;"
                            ...
                            <div @click.away="showImportModal = false"
                                ...
                                <div class="flex justify-between items-center mb-6">
                                    <h3 class="text-lg font-black text-gray-800 tracking-tight">Import Business Units
                                    </h3> <button @click="showImportModal = false"
                                ...
                                <form action="{{ route('business-units.import') }}" method="POST"
                                    enctype="multipart/form-data" class="space-y-6"> @csrf <div> <label
                                        ...
                                        <div
                                            ...
                                            <p class="font-bold mb-1">CSV Format required (exactly matches layout
                                                headers):</p>
                                            <p>Business Unit Code, Business Unit Name</p>
                                        </div>
                                    </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-black/5">
                            <tr>
                                ...
                                <th
                                    class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-white/10">
                                    Business Unit Code</th>
                                <th
                                    class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-white/10">
                                    Business Unit Name</th>
                                <th
                                    class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-white/10">
                                    Status</th>
                                <th
                                ...
                                @foreach ($businessUnits as $unit)
                                    <tr class="hover:bg-white/40 transition-all group">
                                        ...
                                        <td
                                            ...
                                            {{ $unit->business_unit_code }} </td>
                                        <td class="px-8 py-4"> <span
                                                class="text-sm font-black text-gray-800 tracking-tight">{{ $unit->business_unit_name }}</span>
                                        </td>
                                        <td class="px-8 py-4"> <span
                                        ...
                                        <td class="px-8 py-4 text-[11px]">
                                            <div class="flex items-center space-x-3"> <a
                                                    href="{{ route('business-units.edit', $unit) }}"
                                                ...
                                                <form action="{{ route('business-units.destroy', $unit) }}"
                                                    method="POST"
            ...
            <div class="mt-4"> {{ $businessUnits->links() }} </div>
    </div>
</x-app-layout>
