<x-app-layout>
    <x-slot name="header">Edit Function</x-slot>
        ...
        <div class="glass-card overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-gray-100 bg-white/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-gray-800 tracking-tight">Modify Function</h2>
                        <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Refining: {{ $jobFunction->function_name }}</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('job-functions.update', $jobFunction) }}" method="POST" class="p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="function_code" value="{{ old('function_code', $jobFunction->function_code) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="function_name" value="{{ old('function_name', $jobFunction->function_name) }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        ...
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-[#004499]/20 focus:border-[#004499] transition-all resize-none">{{ old('description', $jobFunction->description) }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="status" value="1" class="sr-only peer" {{ $jobFunction->status ? 'checked' : '' }}>
