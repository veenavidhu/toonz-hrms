    ...
    <div class="px-6 pb-12 max-w-4xl mx-auto">
        <div class="glass-card overflow-hidden bg-white">
            <div class="p-10 border-b border-gray-100">
                <h2 class="text-2xl font-black text-gray-800 tracking-tight">Business Unit Registration</h2>
                <p class="text-sm text-gray-500 font-medium mt-1">Create a new business unit to organize departments and operations.</p>
            </div>

            <form action="{{ route('business-units.store') }}" method="POST" class="p-10 space-y-8">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 ml-1 font-medium">Unique identifier for this unit.</p>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="business_unit_name" id="business_unit_name" required
                            value="{{ old('business_unit_name') }}"
                            class="w-full px-4 py-3 bg-gray-50 border-2 border-[#E5E7EB] hover:border-gray-400 rounded-xl text-sm font-bold placeholder:text-gray-300 outline-none focus:bg-white duration-300 focus:border-black focus:ring-0 transition-all"
                            placeholder="e.g. Operations">
                        <p class="text-[10px] text-gray-400 mt-1 ml-1 font-medium">The official name of the business unit.</p>
