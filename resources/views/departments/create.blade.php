    ...
    <div class="px-6 pb-12 max-w-4xl mx-auto">
        <div class="glass-card overflow-hidden bg-white">
            <div class="p-10 border-b border-gray-100">
                <h2 class="text-2xl font-black text-gray-800 tracking-tight">Department Registration</h2>
                <p class="text-sm text-gray-500 font-medium mt-1">Please fill out this form to register a new organizational unit within the system.</p>
            </div>

            <form action="{{ route('departments.store') }}" method="POST" class="p-10 space-y-8">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="name" id="name" required
                            ...
                            value="{{ old('name') }}" placeholder="e.g. Engineering">
                        <p class="text-[10px] text-gray-400 mt-1 ml-1 font-medium">Enter the full name of the department.</p>
                        @error('name')
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 ml-1 font-medium">Select the individual responsible for this unit.</p>
                        @error('manager_id')
                            <p class="text-[10px] text-rose-500 font-bold mt-1 ml-2">{{ $message }}</p>
                        @enderror
                    </div>
