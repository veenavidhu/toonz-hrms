    ...
    <div class="px-6 pb-12 max-w-4xl mx-auto">
        <div class="glass-card overflow-hidden bg-white">
            <div class="p-10 border-b border-gray-100">
                <h2 class="text-2xl font-black text-gray-800 tracking-tight">Sub Business Unit Registration</h2>
                <p class="text-sm text-gray-500 font-medium mt-1">Create a secondary business division for more granular organization.</p>
            </div>

            <form action="{{ route('sub-business-units.store') }}" method="POST" class="p-10 space-y-8">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="sub_business_unit_name" id="sub_business_unit_name" required
                            value="{{ old('sub_business_unit_name') }}"
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 ml-1 font-medium">The official name of the sub-division.</p>
