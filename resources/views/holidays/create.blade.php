        ...
        <div class="glass-card overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-gray-100 bg-white/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-gray-800 tracking-tight uppercase">ADD NEW HOLIDAY</h2>
                    </div>
                </div>
            </div>

            <form action="{{ route('holidays.store') }}" method="POST" class="p-8 space-y-8">
                @csrf
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="radio" name="is_mandatory" value="1" class="w-4 h-4 text-[#004499] border-gray-300 focus:ring-[#004499]/20" checked>
                                <span class="text-sm font-bold text-gray-600 group-hover:text-[#004499] transition-colors">Mandatory</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="radio" name="is_mandatory" value="0" class="w-4 h-4 text-[#004499] border-gray-300 focus:ring-[#004499]/20">
