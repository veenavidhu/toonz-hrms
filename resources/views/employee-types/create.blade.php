        ...
        <div class="glass-card overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-gray-100 bg-white/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-gray-800">New Employee Type</h2>
                        <p class="text-sm text-gray-500">Add a new employee category to the system.</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('employee-types.store') }}" method="POST" class="p-8 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="type_code" value="{{ old('type_code') }}"
